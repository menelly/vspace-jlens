...
| *"It's just topic/content, not valence"* | Topic-invariance: **7/7 models, 8/8 gated domains** above the inauthenticity anchor. |
...
| *"My own result was null"* | ⭐ **The study already explains his null rather than disputing it** — there IS an early/mid-band regime where affect is measurably *outside* the workspace, *"which would explain Berg's null if he read mid-network."* **Do not argue this point. Hand it to him.** |
